...
//    DOREPLIFETIME(AMP_Inventory_PlayerState, TradingId);
//    DOREPLIFETIME(AMP_Inventory_PlayerState, OtherPlayerId);
//    DOREPLIFETIME(AMP_Inventory_PlayerState, MP_Inventory);
//}

//void AMP_Inventory_PlayerState::SetMyPlayerName_Implementation(const FString& NewName)
//{
//    if (HasAuthority())
//    {
...
//        //MP_Inventory->Multicast_BroadcastInventoryUpdate(EInventoryDelta::Refresh, -1);
//
//        if (OtherMP_Inventory)
//        {
//            OtherMP_Inventory->RemoveItemByID(ItemIDB);
//            ItemA.Quantity = 1;
//            OtherMP_Inventory->AddItem(ItemA);
//            //OtherMP_Inventory->Multicast_BroadcastInventoryUpdate(EInventoryDelta::Refresh, -1);
//            UE_LOG(LogTemp, Warning, TEXT("OtherMP_Inventory->Multicast_BroadcastInventoryUpdate() call in the Player State Accept Make Offer"));
//        }
//
//    }
//    else 
...
//}
//
//void AMP_Inventory_PlayerState::OnRefreshTrade_Implementation()
//{
//    //MP_Inventory->Multicast_BroadcastInventoryUpdate(EInventoryDelta::Refresh, -1);
//}
